 ...
 * in which case Maglev will introspect the record to build the
 * corresponding URL.
 *
 ...
 *
 * When taking advantage of model awareness, be sure to configure Maglev
 ...
 *
 *     this.datastore(require('maglev-mongoose'));
 *
