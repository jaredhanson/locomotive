 ...
 * `action.jade.html` results in mixed conventions that can cause confusion.
...
Locomotive.prototype.boot = function(dir, env, options, callback) {
  ...
  // TODO: All these options look kind of messy.  It be nice to clean this up
  //       somehow.
  options = options || {};
  ...
  // TODO: Review the boot squence.  It may be preferrable to load environments
  //       before initializers, so they can switch based on env.
