 ...
 * for example, an instance of `Song` maps to `SongsController`.  However, some
 * datastores have APIs that don't conform to this (rather simplistic)
 * heuristic.  To accomodate such datastores, adapters can be registered with
 * Locomotive that provide the necessary introspection logic.
 *
 * @param {Module} store
 * @api public
 */
