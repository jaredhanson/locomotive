...
function urlFor(req, res) {
  ...
  return function(options) {
    ...
    if (options.constructor.name !== 'Object') {
      ...
      var helperName = inflect._helperize(recordof, 'URL');
    ...
    options = options || {};
    options.controller = inflect._controllerize(options.controller) || req._locomotive.controller;
    options.action = inflect._actionize(options.action) || req._locomotive.action;
