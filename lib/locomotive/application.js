...
Application.prototype._controller = function(id, cb) {
  ...
  if (!mod) {
    ...
    try {
      ...
      // TODO: If a auto-required controller contains a SyntaxError, the message
      //       less than helpful.  Improve this situation.
 ...
 * @api public
 */
Application.prototype.invoke = function(options) {
 ...
 * @api public
 */
Application.prototype.boot = function(dir, env, options, callback) {
  ...
  this.phase(require('./boot/fallbacks')(options, this));
