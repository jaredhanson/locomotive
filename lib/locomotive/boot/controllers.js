...
module.exports = function(options, appArg) {
  ...
  return function controllers() {
    ...
    appArg.controllers.resolve.use(require('../resolvers/node/controller')(dirname));
    appArg.controllers.instantiate.use(require('../instantiators/prototype')());
    appArg.controllers.instantiate.use(require('../instantiators/constructor')());
  }
}
