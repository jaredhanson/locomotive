module.exports = require('actionrouter').Router;
return;


// FIXME: The code below is the old, built-in router which has been refactored
//        into 'actionrouter'.  Port existing functionality and remove the code
//        below.
