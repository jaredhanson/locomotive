...
Router.prototype.resource = function(name, fn) {
  ...
  this._route('get' , path + '/new'     , controller, 'new'     , { helper: 'new' + utils.capitalize(helper) });
  this._route('post', path              , controller, 'create' );
  this._route('get' , path + '.:format?', controller, 'show'    , { helper: helper });
  this._route('get' , path + '/edit'    , controller, 'edit'    , { helper: 'edit' + utils.capitalize(helper) });
...
Router.prototype.resources = function(name, fn) {
  ...
  this._route('get' , path + '/:id/edit'     , controller, 'edit'    , { helper: 'edit' + utils.capitalize(helper) });
