...
var serverJS = [
  ...
  , 'app.phase(locomotive.boot.controllers(__dirname + \'/app/controllers\', app));'
  ...
  , 'app.phase(require(\'bootable-environment\')(__dirname + \'/config/environments\', app));'
  , 'app.phase(bootable.initializers(__dirname + \'/config/initializers\', app));'
  , 'app.phase(locomotive.boot.routes(__dirname + \'/config/routes\', app));'
  , 'app.phase(locomotive.boot.httpServer({ address: \'0.0.0.0\', port: 3000 }, app));'
  , ''
