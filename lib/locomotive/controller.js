...
Controller.prototype.render = function() {
  ...
  var view = this.__viewDir + '/' + this.__action + '.' + 'html' + '.ejs';
...
Controller.prototype._init = function(name) {
  this.__name = name;
  this.__viewDir = inflect.underscore(inflect.decontrollerize(name));
}
...
Controller.prototype._invoke = function(action) {
  if (typeof this[action] !== 'function') {
    return this.__next(new ControllerError(this.__name + '#' + action + ' is not callable'));
  }
