...
describe('Controller#before', function() {
  ...
  describe('all filter declared above action', function() {
    var app = new MockApplication();
    var proto = new Controller();
  ...
  describe('all filter declared below action', function() {
    var app = new MockApplication();
    var proto = new Controller();
  ...
  /* variations of callback function signature */
  ...
  describe('filters, one of which errors early', function() {
    var app = new MockApplication();
    var controller = new Controller();
    controller.order = [];
